  ...
  return (
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-1s">
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://drive.google.com/drive/folders/1w29ofIjJ9vrLQTviLmIR1asvJbQYOwiS?usp=sharing" 
            target="_blank" rel="noopener noreferrer" className="bg-violet-700 p-4 rounded-2xl hover:bg-violet-600">
      ...
      <div className="tentang mt-32 py-10" id="tentang">
        <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="300">
          <img src={DataImage.HeroImage} alt="Hero Image" className="w-12 rounded-md mb-10 sm:hidden" loading="lazy"/>
          <p className="text-base/loose mb-10">
          Hi, perkenalkan saya Faiq Misbah Yazdi, seorang UI/UX Designer dan Data Analyst. 
        ...
        <div className="tools mt-32">
          ...
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            ...
            {listTools.map((tool) => (
              ...
              rounded-md hover:bg-zinc-800 group" key={tool.id} data-aos="fade-up" data-aos-duration="3000" data-aos-delay={tool.dad}>
