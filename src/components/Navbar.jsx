...
const Navbar = () => {
    ...
    <div className="logo">
        <h1 className="text-3xl font-bold p-1 text-white bg-transparent
          hidden sm:block animate__animated animate__fadeInDown animate__delay-1s">Portofolio</h1>
    </div>
    ...
    md:bg-transparent transition-all md:transition-none z-50 animate__animated animate__fadeInDown animate__delay-1s
    ${active ? "top-0 opacity-100" : "-top10 opacity-0"}`}>
        <li>
